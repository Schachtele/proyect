...
CREATE TABLE `calificaciones` (
  ...
  CONSTRAINT `calificaciones_ibfk_1` FOREIGN KEY (`Id_Postulante`) REFERENCES `postulantes` (`Id_Postulante`),
  CONSTRAINT `calificaciones_ibfk_2` FOREIGN KEY (`Id_Area`) REFERENCES `areas` (`Id_Area`),
